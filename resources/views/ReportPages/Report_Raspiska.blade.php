		...
		<div class="wrap-list">
			<div class="col" style="width: 145.5mm; height: 100%; float: left;">
				<div class="row" style="margin: 5mm 10mm 0mm 12mm; font-size: 18px;">
					<table>
						<tr>
							...
							<td style="padding-left: 12mm;"><b>ШИФР О2Фин330</b></td>
						</tr>
					</table>
				</div>
				<div class="row" style="margin-left: 12mm; margin-top: 2mm;">
					<table>
						<tr>
							<td>
								ФИО: Афанасенко Алина Александровна
							</td>
						</tr>
						<tr>
							<td>
				...
				<div class="row" style="margin-left: 12mm; margin-top: 2mm;">
					...
					<ol class="pr_doc_ol" style="padding:0; padding-left: 4mm; max-width: 120mm;">
						<li>Заявление</li>
						<li>2 фотографий</li>
						<li>Документ об образовании СО №0000471 от 2019-06-19 выдан
					ГБОУ СОО ЛНР "Червонопартизанская гимназия</li>
						<li>копия паспорта</li>
						<li>медицинская справка О86-у</li>
						<li>справка прививок О63-у</li>
			...
			<div class="col" style="width: 146mm; height: 100%; float: left;">
				<div class="row" style="margin: 5mm 10mm 0mm 12mm; font-size: 15px;">
					<p style="text-decoration: underline"><b>Луганский национальный университет имени Тараса Шевченко</b></p>
				</div>
				...
				<div class="row" style="margin-left: 5mm;">
					<table>
						<tr>
							...
							<td style="padding-left: 15mm;"><b>О2Фин330</b></td>
						</tr>
						<tr>
							<td colspan="2" style="text-decoration: underline; max-width: 122mm">Экономика (Финансы и кредит)</td>
						</tr>
						<tr>
							<td colspan="2" style="max-width: 122mm; padding-top: 5mm;">От <span style="text-decoration: underline;">Афанасенко Алина Александровна</span></td>
						</tr>
					</table>
				</div>
				<div class="row" style="margin-left: 5mm;">
